...
for article in exercise['response']['results']:
    article['views'] = 0
print(exercise['response']['results'])
...
def read_article():
    r = random.randint(0,len(exercise['response']['results'])-1)
    exercise['response']['results'][r]['views'] += 1
    print(r)
    print(exercise['response']['results'])
