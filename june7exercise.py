...
# dict_keys(['kind', 'id', 'created_at', 'user_id', 'sharing', 'tag_list', 'permalink', 'streamable', 'downloadable', 'embeddable_by', 'purchase_url', 'label_id', 'type', 'playlist_type', 'ean', 'description', 'genre', 'release', 'purchase_title', 'label_name', 'title', 'release_year', 'release_month', 'release_day', 'license', 'uri', 'permalink_url', 'artwork_url', 'user', 'tracks'])
...
# Find keys of each dictionary in track list
for track in playlist_data['tracks']:
        print(track.keys())
dict_keys(['kind', 'id', 'created_at', 'user_id', 'duration_in_milliseconds', 'commentable', 'state', 'original_content_size', 'sharing', 'tag_list', 'permalink', 'streamable', 'embeddable_by', 'downloadable', 'purchase_url', 'label_id', 'purchase_title', 'genre', 'title', 'description', 'label_name', 'release', 'track_type', 'key_signature', 'isrc', 'video_url', 'bpm', 'release_year', 'release_month', 'release_day', 'original_format', 'license', 'uri', 'user', 'permalink_url', 'artwork_url', 'waveform_url', 'stream_url', 'playback_count', 'download_count', 'favoritings_count', 'comment_count', 'attachments_uri'])

# Sum up total duration of each track
total_duration_in_milliseconds = 0
for track in playlist_data['tracks']:
    total_duration_in_milliseconds += track['duration_in_milliseconds'] 
total_duration_in_minutes = total_duration_in_milliseconds / 1000 / 60
print(total_duration_in_milliseconds)
print(total_duration_in_minutes)